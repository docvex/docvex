...
const STRINGS = {
  en: {
    ...
    saving: 'Saving…',
    foreignNote: 'This file wasn’t written in DocVex, so what you fill in here is a preview only — it isn’t written to the file (that would rebuild it from plain text and lose its Word formatting).',
  ...
  ro: {
    ...
    saving: 'Se salvează…',
    foreignNote: 'Acest fișier nu a fost scris în DocVex. Salvarea din Constructor îl reconstruiește din text, așa că formatarea specifică Word — tabele, imagini, stiluri proprii — este simplificată.',
