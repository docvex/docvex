...
### ⬇️ [Download Docvex for Windows (v5.4.0)](https://github.com/petreluca1105-dotcom/docvex/releases/download/v5.4.0/docvex-5.4.0.Setup.exe)
...
> **Direct link for the current version:** [docvex-5.4.0.Setup.exe](https://github.com/petreluca1105-dotcom/docvex/releases/download/v5.4.0/docvex-5.4.0.Setup.exe)
...
### Windows
1. Click **[Download docvex-5.4.0.Setup.exe](https://github.com/petreluca1105-dotcom/docvex/releases/download/v5.4.0/docvex-5.4.0.Setup.exe)** (or [grab the latest](https://github.com/petreluca1105-dotcom/docvex/releases/latest)).
