...
### ⬇️ Download Docvex (v7.1.0)

- **Windows:** [docvex-7.1.0.Setup.exe](https://github.com/petreluca1105-dotcom/docvex/releases/download/v7.1.0/docvex-7.1.0.Setup.exe)
- **macOS (Apple Silicon):** [docvex-darwin-arm64-7.1.0.zip](https://github.com/petreluca1105-dotcom/docvex/releases/download/v7.1.0/docvex-darwin-arm64-7.1.0.zip)
- **macOS (Intel):** [docvex-darwin-x64-7.1.0.zip](https://github.com/petreluca1105-dotcom/docvex/releases/download/v7.1.0/docvex-darwin-x64-7.1.0.zip)
...
> - Windows installer: [docvex-7.1.0.Setup.exe](https://github.com/petreluca1105-dotcom/docvex/releases/download/v7.1.0/docvex-7.1.0.Setup.exe)
> - macOS Apple Silicon (M-series): [docvex-darwin-arm64-7.1.0.zip](https://github.com/petreluca1105-dotcom/docvex/releases/download/v7.1.0/docvex-darwin-arm64-7.1.0.zip)
> - macOS Intel: [docvex-darwin-x64-7.1.0.zip](https://github.com/petreluca1105-dotcom/docvex/releases/download/v7.1.0/docvex-darwin-x64-7.1.0.zip)
...
| Mac | Download |
| --- | --- |
| **Apple Silicon** (M1 / M2 / M3 / M4) — most Macs since late 2020 | [docvex-darwin-arm64-7.1.0.zip](https://github.com/petreluca1105-dotcom/docvex/releases/download/v7.1.0/docvex-darwin-arm64-7.1.0.zip) |
| **Intel** — Macs from 2020 and earlier | [docvex-darwin-x64-7.1.0.zip](https://github.com/petreluca1105-dotcom/docvex/releases/download/v7.1.0/docvex-darwin-x64-7.1.0.zip) |
