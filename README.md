...
### ⬇️ Download Docvex (macOS v7.2.4 · Windows v7.2.4)

- **Windows:** [docvex-7.2.4.Setup.exe](https://github.com/petreluca1105-dotcom/docvex/releases/download/v7.2.4/docvex-7.2.4.Setup.exe)
- **macOS (Apple Silicon):** [docvex-7.2.4-arm64.dmg](https://github.com/petreluca1105-dotcom/docvex/releases/download/v7.2.4/docvex-7.2.4-arm64.dmg) installer · [portable .zip](https://github.com/petreluca1105-dotcom/docvex/releases/download/v7.2.4/docvex-darwin-arm64-7.2.4.zip)
- **macOS (Intel):** [docvex-7.2.4-x64.dmg](https://github.com/petreluca1105-dotcom/docvex/releases/download/v7.2.4/docvex-7.2.4-x64.dmg) installer · [portable .zip](https://github.com/petreluca1105-dotcom/docvex/releases/download/v7.2.4/docvex-darwin-x64-7.2.4.zip)
...
> - Windows installer: [docvex-7.2.4.Setup.exe](https://github.com/petreluca1105-dotcom/docvex/releases/download/v7.2.4/docvex-7.2.4.Setup.exe)
> - macOS Apple Silicon (M-series): [docvex-7.2.4-arm64.dmg](https://github.com/petreluca1105-dotcom/docvex/releases/download/v7.2.4/docvex-7.2.4-arm64.dmg) (or [portable .zip](https://github.com/petreluca1105-dotcom/docvex/releases/download/v7.2.4/docvex-darwin-arm64-7.2.4.zip))
> - macOS Intel: [docvex-7.2.4-x64.dmg](https://github.com/petreluca1105-dotcom/docvex/releases/download/v7.2.4/docvex-7.2.4-x64.dmg) (or [portable .zip](https://github.com/petreluca1105-dotcom/docvex/releases/download/v7.2.4/docvex-darwin-x64-7.2.4.zip))
...
### Windows
1. Click **[Download docvex-7.2.4.Setup.exe](https://github.com/petreluca1105-dotcom/docvex/releases/download/v7.2.4/docvex-7.2.4.Setup.exe)** (or [grab the latest](https://github.com/petreluca1105-dotcom/docvex/releases/latest)).
...
| --- | --- | --- |
| **Apple Silicon** (M1 / M2 / M3 / M4) — most Macs since late 2020 | [docvex-7.2.4-arm64.dmg](https://github.com/petreluca1105-dotcom/docvex/releases/download/v7.2.4/docvex-7.2.4-arm64.dmg) | [docvex-darwin-arm64-7.2.4.zip](https://github.com/petreluca1105-dotcom/docvex/releases/download/v7.2.4/docvex-darwin-arm64-7.2.4.zip) |
| **Intel** — Macs from 2020 and earlier | [docvex-7.2.4-x64.dmg](https://github.com/petreluca1105-dotcom/docvex/releases/download/v7.2.4/docvex-7.2.4-x64.dmg) | [docvex-darwin-x64-7.2.4.zip](https://github.com/petreluca1105-dotcom/docvex/releases/download/v7.2.4/docvex-darwin-x64-7.2.4.zip) |
